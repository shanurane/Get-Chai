  ...
  return (
    <div className="text-white py-14 container mx-auto">
      ...
      <div className="flex flex-col items-center gap-2 p-10">
        <button className="flex items-center w-64 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
        ...
        <button
          onClick={() => signIn()}
          className="flex items-center w-64 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        >
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
